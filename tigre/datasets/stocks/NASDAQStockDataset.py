...
class NASDAQStockDataset(StockDataset):
    def __init__(self, date_range: Tuple[str, str] = (None, None), features: List[str] = None, normalize: bool = None):
        ...
        Also refer to docstrings in tigre/datareaders/StockWindowDataReader.py > _build_window_inputs
        """
